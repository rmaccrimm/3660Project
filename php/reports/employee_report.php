...
<head>
    ...
    <script src="../../js/employee_report_php.js"></script>
</head>
<body>
...
<div id="content-wrapper">
    ...
    <!-- Page name -->
    <h1 id="page_name">Employee Info</h1>
    <!-- /Page name -->


    <!-- Content -->
    <div id="page_content">
        <form name="employee_name" id="employee_name">
            <label for="name_hint">Full Name: </label>
            <input type="text" id="name_hint" name="name_hint" />
            <input type="submit", value="Submit" />
        </form>

        <div id="employee_report_result">
        </div>
    </div>
    <!-- /Content -->
    ...
    <?php
    $query_names = 'SELECT first_name, last_name FROM employee';
